...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <SEOProvider
        title="Privacy Policy | Jupi Diamonds - Data Protection & Security"
        description="Read Jupi Diamonds' comprehensive privacy policy outlining how we collect, use, and protect your personal information when you use our services."
        keywords={[
          "jewelry store privacy policy",
          "data protection jewelry",
          "online jewelry security",
          "personal information policy",
          "diamond website privacy",
          "secure shopping policy",
        ]}
        url={window.location.href}
      />
      <div className="max-w-7xl mx-auto px-6 sm:px-4 py-6 sm:py-12 text-gray-800 leading-relaxed tracking-wide">
        <h1 className="text-center text-xl font-medium text-black">
          Privacy Policy
        </h1>
        <p className=" text-center sm:text-start text-sm text-[#1E1E1E] mt-1">
          Last updated: April 6, 2025
        </p>

        <section className="mt-6">
          <h2 className="text-xl sm:text-2xl font-normal mb-1 sm:mb-2 text-black">
            Introduction
          </h2>
          <p className="text-sm text-[#27282C] sm:ml-10">
            This Privacy Policy describes Our policies and procedures on the
            collection, use and disclosure of Your information when You use the
            Service and tells You about Your privacy rights and how the law
            protects You.
          </p>
          <p className="mt-2 text-sm text-[#27282C]  sm:ml-10">
        ...
        <section className="mt-10">
          ...
          <h3 className="text-sm font-medium  sm:ml-10 text-black">
            Interpretation
          </h3>
          <p className="text-sm text-[#27282C] sm:ml-10">
          ...
          <h3 className="text-sm font-medium mt-4 sm:ml-10 text-black">
            Definitions
          </h3>
          <p className="text-sm text-[#27282C] sm:ml-10">
          ...
          <ul className="list-disc list-outside mt-2 space-y-3 text-sm text-[#27282C] ml-8 sm:ml-16 ">
            <li>
            ...
            <li>
              <span className="text-sm font-medium text-black ">Affiliate</span>{" "}
            ...
            <li>
              ...
              Agreement) refers to Jupi Diamonds, I-87 SF, South City-2 Sector
              50 Gurugram Haryana -122018.
            </li>
            <li>
              <span className="text-sm font-medium text-black">Cookies</span>{" "}
            ...
            <li>
              <span className="text-sm font-medium text-black">Device</span>{" "}
            ...
            <li>
              ...
              is any information related to an identified or identifiable
              individual.
            </li>
            <li>
            ...
            <li>
              <span className="text-sm font-medium text-black">Usage Data</span>{" "}
            ...
            <li>
              ...
              refers to Jupi Diamonds, accessible from jupidiamonds.com
            </li>
            <li>
              <span className="text-sm font-medium text-black">You</span> means
        ...
        <section className="mt-10">
          ...
          <h3 className="text-sm font-medium mt-2 sm:ml-10 text-black">
            Personal Data
          </h3>
          ...
          <ul className="list-disc list-outside mt-2 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            <li>Email address</li>
          ...
          <h3 className="text-sm font-medium mt-6 sm:ml-10 text-black">
            Usage Data
          </h3>
          <p className="text-sm text-[#27282C] mt-2 sm:ml-10">
          ...
          <p className="text-sm text-[#27282C] mt-4 sm:ml-10">
          ...
          <p className="text-sm text-[#27282C] mt-1 sm:ml-10 ">
          ...
          <ul className="list-disc list-outside mt-6 space-y-3 text-sm text-[#27282C] ml-8 sm:ml-16">
            <li>
              <span className="text-sm font-medium text-black">
          ...
          <p className="text-sm text-[#27282C] mt-6 sm:ml-10 ">
        ...
        <section className="mt-10">
          ...
          <h4 className="text-sm font-medium mt-4 sm:ml-10 text-black">
            Necessary / Essential Cookies
          </h4>
          <ul className="list-disc list-outside mt-1 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            <li>
            ...
            <li>
              <span className="font-medium">Purpose:</span> These Cookies are
          ...
          <ul className="list-disc list-outside mt-1 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            ...
            <li>
              <span className="font-medium">Purpose:</span> These Cookies allow
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc list-outside mt-2 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            ...
            <li>
              <span className="font-medium text-black">To contact You:</span> To
            ...
            <li>
              <span className="font-medium text-black">To provide You</span>{" "}
          ...
          <ul className="list-disc list-outside mt-1 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            ...
            <li>
              <span className="font-medium text-black">With Affiliates:</span>{" "}
            ...
            <li>
              <span className="font-medium text-black">With other users:</span>{" "}
            ...
            <li>
              <span className="font-medium text-black">With Your consent:</span>{" "}
        ...
        <section className="mt-10">
          <h3 className="text-xl sm:text-2xl font-normal mb-1 sm:mb-2 text-black">
            Children's Privacy
          </h3>
          <p className="text-sm text-[#27282C]  sm:ml-10">
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc list-outside mt-2 space-y-1 text-sm text-[#27282C] ml-8 sm:ml-16">
            <li>By email: support@jupidiamonds.com</li>
          </ul>
        </section>
      </div>
    </>
